...
crudApp.controller('ProfileController', function ($scope, $http, $compile) {
	$scope.user = {
		username: "John Cena",
	...
	$scope.setUser = function(username){
		$http.get('/api/v1/users/profile?username='+username)
		...
		$http.get('/api/v1/users/hasEditPermission?username='+username)
		.success(function(data, status, headers, config){
